//LOCAL STORAGE SALVA OS DADOS SEM DATA DE EXPIRAÇÃO E NEM OS EXCLUI QUANDO O NAVEGADOR É FECHADO
...
//SESSION STORAGE SALVA OS DADOS APENAS NA SECÇÃO ATUAL
...
//Exemplo JSON.stringify() e JSON.parse()
const myObj = {
  name: 'Link',
  age: 20,
};
...
localStorage.setItem('peixe', JSON.stringify(myObj));
...
const recoveredObject = JSON.parse(localStorage.getItem('peixe'));
...
//Mais exemplos de salvamento do localStorage e sessionStorage
